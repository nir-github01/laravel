<div class="container">
    <form class="row g-3" style="margin-top: 5%">
        <div class="row">
            <div class="col">
              <input type="hidden" class="form-control" placeholder="id" wire:model='id'>
            </div>
            <div class="col">
        ...
        <div class="col-md-6">
          <input type="hidden" class="form-control" id="inputPostId" wire:model='post_id'>
        </div>
        <div class="col-md-6">
        ...
        {{-- <div class="col-md-2">
          <label for="inputZip" class="form-label" wire:model='zip_code'>Zip Code</label>
        ...
        <div>
          <button wire:submit.prevent="update()" class="btn btn-success">Update</button>
        </div>
    </form>   
</div>